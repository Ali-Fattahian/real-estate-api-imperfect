...
class Profile(TimeStampedUUIDModel):
    ...
    license = models.CharField(verbose_name=_('Real Estate License'), max_length=20, blank=True, default='')
    profile_photo = models.ImageField(verbose_name=_('Profile Photo'), blank=True, default='/profile_default.png')
    gender = models.CharField(verbose_name=_('Gender'), choices=Gender.choices, default=Gender.MALE, max_length=20, blank=True)
    country = CountryField(verbose_name=_('Country'), default='UK', blank=True)
    city=models.CharField(verbose_name=_('City'), max_length=100, default='London', blank=True)
