...
class Property(TimeStampedUUIDModel):
    ...
    slug = AutoSlugField(populate_from="title", unique=True, always_update=True)  # type: ignore
    ...
    price = models.DecimalField(
        verbose_name=_("Price"), max_digits=8, decimal_places=2, default=0.0  # type: ignore
    )
    tax = models.DecimalField(
        verbose_name=_("Property Tax"),
        max_digits=6,
        decimal_places=2,
        default=0.15,  # type: ignore
        help_text="15% property tax charged",
    )
    plot_area = models.DecimalField(
        verbose_name=_("Plot Area(m^2)"), max_digits=8, decimal_places=2, default=0.0  # type: ignore
    )
    ...
    bathrooms = models.DecimalField(
        verbose_name=_("Bathrooms"), max_digits=4, decimal_places=2, default=1.0  # type: ignore
    )
